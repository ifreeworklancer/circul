...
function woocommerce_init()
{
    ...
    class WC_Gateway_Liqpay extends WC_Payment_Gateway
    {
          ...
          <div class="inline error">
            <p>
              <strong><?php _e('Шлюз отключен',
                      'woocommerce'); ?></strong>: <?php _e('Liqpay не поддерживает валюты Вашего магазина.',
                    'woocommerce'); ?>
            </p>
          </div>
        ...
        public function init_form_fields()
        {
            ...
            $this->form_fields = array(
                ...
                'description' => array(
                    ...
                    'default' => __('Оплатить с помощью платежной системы LiqPay::Pay with LiqPay payment system',
                        'woocommerce'),
                    'desc_tip' => true,
                ),
                'pay_message' => array(
                ...
                'lang' => array(
                    ...
                    'default' => 'ru',
                    'options' => array(
                        'ru' => __('ru', 'woocommerce'), 'en' => __('en', 'woocommerce'),
                        'ru/en' => __('ru + en', 'woocommerce')
                    ),
                    'description' => __('Язык интерфейса (Для ru + en установите мультиленг плагин. Разделение языков с помощью :: .)',
                        'woocommerce'),
                    'desc_tip' => true,
                ),
                'lang_function' => array(
                ...
                'sandbox' => array(
                    ...
                    'label' => __('Включить', 'woocommerce'),
                    'type' => 'checkbox',
                    'description' => __('Данный режим, поможет протестировать оплату, без снятия средств с карточек',
                        'woocommerce'),
                    'desc_tip' => true,
                ),
                'redirect_page' => array(
        ...
        public function generate_form($order_id)
        {
            ...
            if (isset($_COOKIE['premmerce_users_currency'])) {
                $currency = Model::getCurrencies(true)[$_COOKIE['premmerce_users_currency']]['code'];
            } else {
        ...
        public function cnb_form($params)
        {
            ...
            if (trim($this->button) == '') {
                $button = '<input type="image" style="width: 160px" 
src="https://static.liqpay.ua/buttons/p1ru.radius.png" name="btn_text" />';
            } else {
